...
pthread_t pref_thread = -1;	//yan - Apr 10 2012
void *pref_listener(void *arg);	//yan - Apr 10 2012
...
int main_loop(int argc, char **argv)
{
	...
	int optval=1;
	int preferences = IPV6_PREFER_SRC_COA;	//yan - get rid of home address
#ifndef __WIN32__
	...
	//yan - preference thread - Apr 10 2012
	/*
	int r;
	...
	r = system("sudo ip route add table 200 1.0.0.0/8 dev hip0");
	*/
	pthread_create(&pref_thread, NULL, pref_listener, NULL);
	//yan - end
	...
	setsockopt(s6_hip, IPPROTO_IPV6, IPV6_ADDR_PREFERENCES,
			(void *) &preferences, sizeof(preferences));	//yan - get rid of hoa
