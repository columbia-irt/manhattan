#This is run on the Server to discover clients that can play the media it has
import wx
import pygst
pygst.require("0.10")
import gst
...
class Main:
    ...
    def create_table(self):
        ...
        searchbutton.connect("clicked", self.search)  #Attaching Event handler
    ...
    def play(self, toplay):
        ...
        self.pipeline.get_by_name("file-source").set_property("location", "./Heartbeat.mp3")
